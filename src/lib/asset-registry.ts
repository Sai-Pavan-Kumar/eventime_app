...
export const APP_ASSETS = {
  ...
  illustrations: {
    ...
    throneEmpty: require('../../assets/Throne_empty.webp'),
    emptyAlerts: require('../../assets/Empty_alerts.webp'),
    forYou: require('../../assets/For_you.webp'),
    aroundYou: require('../../assets/Around_you.webp'),
    eligibleForMe: require('../../assets/eligible_for_me.webp'),
    noCollegeEvents: require('../../assets/no_college_events.webp'),
  },
  onboarding: {
